...
test_text = """
my boy, my boy, my boy, my boy is funny.
"""
...
Status	Active
Founded	October 1939; 76 years ago (as Timely Comics)
...
Marvel Worldwide Inc., commonly referred to as Marvel Comics formerly Marvel Publishing, Inc. and Marvel Comics Group, is an American publisher of comic books and related media. In 2009, The Walt Disney Company acquired Marvel Entertainment, Marvel Worldwide's parent company.
...
1.7	Disney conglomerate unit
2	Officers
2.1	Publishers
2.2	Editors-in-chief
2.3	Executive Editor
3	Ownership
4	Offices
5	Market share
...
Goodman, now disconnected from Marvel, set up a new company called Seaboard Periodicals in 1974, reviving Marvel's old Atlas name for a new Atlas Comics line, but this lasted only a year and a half.[42] In the mid-1970s a decline of the newsstand distribution network affected Marvel. Cult hits such as Howard the Duck fell victim to the distribution problems, with some titles reporting low sales when in fact the first specialty comic book stores resold them at a later date.[citation needed] But by the end of the decade, Marvel's fortunes were reviving, thanks to the rise of direct market distribution—selling through those same comics-specialty stores instead of newsstands.

Marvel held its own comic book convention, Marvelcon '75, in spring 1975, and promised a Marvelcon '76. At the 1975 event, Stan Lee used a Fantastic Four panel discussion to announce that Jack Kirby, the artist co-creator of most of Marvel's signature characters, was returning to Marvel after having left in 1970 to work for rival DC Comics.[43] In October 1976, Marvel, which already licensed reprints in different countries, including the UK, created a superhero specifically for the British market. Captain Britain debuted exclusively in the UK, and later appeared in American comics.[44]


Marvel Super Heroes Secret Wars #1 (May 1984). Cover art by Mike Zeck.[45]
...
Marvel earned a great deal of money and recognition during the comic book boom of the early 1990s, launching the successful 2099 line of comics set in the future (Spider-Man 2099, etc.) and the creatively daring though commercially unsuccessful Razorline imprint of superhero comics created by novelist and filmmaker Clive Barker.[49][50] In 1990, Marvel began selling Marvel Universe Cards with trading card maker SkyBox International. These were collectible trading cards that featured the characters and events of the Marvel Universe. The 1990s saw the rise of variant covers, cover enhancements, swimsuit issues, and company-wide crossovers that affected the overall continuity of the fictional Marvel Universe

Marvel suffered a blow in early 1992, when seven of its most prized artists—Todd McFarlane (known for his work on Spider-Man), Jim Lee (X-Men), Rob Liefeld (X-Force), Marc Silvestri (Wolverine), Erik Larsen (The Amazing Spider-Man), Jim Valentino (Guardians of the Galaxy), and Whilce Portacio—left to form Image Comics.[51]

In 1996, Marvel had some of its titles participate in "Heroes Reborn", a crossover that allowed Marvel to relaunch some of its flagship characters such as the Avengers and the Fantastic Four, and outsource them to the studios of two of the former Marvel artists turned Image Comics founders, Jim Lee and Rob Liefeld. The relaunched titles, which saw the characters transported to a parallel universe with a history distinct from the mainstream Marvel Universe, were a solid success amidst a generally struggling industry,[52] but Marvel discontinued the experiment after a one-year run and returned the characters to the Marvel Universe proper. In 1998, the company launched the imprint Marvel Knights, taking place within Marvel continuity; helmed by soon-to-become editor-in-chief Joe Quesada, it featured tough, gritty stories showcasing such characters as the Inhumans, Black Panther and Daredevil.


Marvel's logo, circa 1990s
In late 1994, Marvel acquired the comic book distributor Heroes World Distribution to use as its own exclusive distributor.[53] As the industry's other major publishers made exclusive distribution deals with other companies, the ripple effect resulted in the survival of only one other major distributor in North America, Diamond Comic Distributors Inc.[54][55] In early 1997, when Marvel's Heroes World endeavor failed, Diamond also forged an exclusive deal with Marvel[56]—giving the company its own section of its comics catalog Previews.[57]
...
In 1997, Toy Biz and MEG merged to end the bankruptcy, forming a new corporation, Marvel Enterprises.[58] With his business partner Avi Arad, publisher Bill Jemas, and editor-in-chief Bob Harras, Toy Biz co-owner Isaac Perlmutter helped stabilize the comics line.[59]
...
Some of its characters have been turned into successful film franchises, such as the Men in Black movie series, starting in 1997, Blade movie series, starting in 1998, X-Men movie series, starting in 2000, and the highest grossing series Spider-Man, beginning in 2002.[60]

In a cross-promotion, the November 1, 2006, episode of the CBS soap opera The Guiding Light, titled "She's a Marvel", featured the character Harley Davidson Cooper (played by Beth Ehlers) as a superheroine named the Guiding Light.[61] The character's story continued in an eight-page backup feature, "A New Light", that appeared in several Marvel titles published November 1 and 8.[62] Also that year, Marvel created a wiki on its Web site.[63]

In late 2007 the company launched Marvel Digital Comics Unlimited, a digital archive of over 2,500 back issues available for viewing, for a monthly or annual subscription fee.[64]

In 2009 Marvel Comics closed its Open Submissions Policy, in which the company had accepted unsolicited samples from aspiring comic book artists, saying the time-consuming review process had produced no suitably professional work.[65] The same year, the company commemorated its 70th anniversary, dating to its inception as Timely Comics, by issuing the one-shot Marvel Mystery Comics 70th Anniversary Special #1 and a variety of other special issues.[66][67]
...
On August 31, 2009, The Walt Disney Company announced a deal to acquire Marvel Comics' parent corporation, Marvel Entertainment, for $4 billion[68] or $4.2 billion,[69] with Marvel shareholders to receive $30 and 0.745 Disney shares for each share of Marvel they own.[68] As of 2008, Marvel and its major, longtime competitor DC Comics shared over 80% of the American comic-book market.[70] As of September 2010, Marvel switched its bookstores distribution company from Diamond Book Distributors to Hachette Distribution Services.[71]

Marvel relaunched the CrossGen imprint, owned by Disney Publishing Worldwide, in March 2011.[72] Marvel and Disney Publishing began jointly publishing Disney/Pixar Presents magazine that May.[73]

Marvel discontinued its Marvel Adventures imprint in March 2012,[74] and replaced them with a line of two titles connected to the Marvel Universe TV block.[75] Also in March, Marvel announced its Marvel ReEvolution initiative that included Infinite Comics,[76] a line of digital comics, Marvel AR, an application software that provides an augmented reality experience to readers and Marvel NOW!, a relaunch of most of the company's major titles with different creative teams.[77][78] Marvel NOW! also saw the debut of new flagship titles including Uncanny Avengers and All-New X-Men.[79]

In April 2013, Marvel and other Disney conglomerate components began announcing joint projects. With ABC, a Once Upon a Time graphic novel was announced for publication in September.[80] With Disney, Marvel announced in October 2013 that in January 2014 it would release its first title under their joint "Disney Kingdoms" imprint "Seekers of the Weird", a five-issue miniseries.[69] On January 3, 2014, fellow Disney subsidiary Lucasfilm Limited, LLC announced that as of 2015, Star Wars comics would once again be published by Marvel.[81]

Following the events of the company-wide crossover Secret Wars in 2015, a relaunched Marvel universe began in September 2015, called the All-New, All-Different Marvel.[82]

Officers[edit]
Michael Z. Hobson, Executive Vice President, Publishing[83] Group vice-president, publishing (1986)[84]
Stan Lee, executive vice president & publisher (1986)[84]
Joseph Calamari, executive vice president (1986)[84]
Jim Shooter, vice president and Editor-in-Chief (1986)[84]
Publishers[edit]
Abraham Goodman 1939[8] – ?
Martin Goodman ? – 1972[38]
Charles "Chip" Goodman 1972[38]
Stan Lee 1972 – October 1996[38][39][83]
Shirrel Rhoades October 1996 – October 1998[83]
Winston Fowlkes February 1998 – November 1999[83]
Bill Jemas February 2000 – 2003[83]
Dan Buckley 2003–present[85]
...
Editor
Martin Goodman (1939–1940; titular only)[8]
Joe Simon (1940–1941)
Stan Lee (1941–1942)
...
Carl Potts, Epic Comics & general entertainment[86]
...
Jim Shooter January 5, 1976 – January 2, 1978[87]
Executive Editor
Tom DeFalco 1987
Mark Gruenwald 1987–1994, senior editor 1995–1996
Carl Potts Epic 1989–1994,[86] 1995–
Bob Budiansky early '90s – 1994[86]
Bobbie Chase 1995–2001
Tom Brevoort 2007–present[88]
Axel Alonso 2010 – January 2011[89]
Ownership[edit]
...
in the McGraw-Hill Building,[8][90] where it originated as Timely Comics in 1939
in suite 1401 of the Empire State Building[90]
at 635 Madison Avenue (the actual location, though the comic books' indicia listed the parent publishing-company's address of 625 Madison Ave.)[90]
575 Madison Avenue;[90]
387 Park Avenue South[90]
10 East 40th Street[90]
417 Fifth Avenue[90]
a 60,000-square-foot (5,600 m2) space at 135 W. 50th Street[91][92]
Market share[edit]
...
In 2013, Marvel held a 33.50% share of the comics market, compared to its competitor DC Comics' 30.33% share. By comparison, the companies held 40.81% and 29.94% shares in 2008, respectively.[93]
...
Games[edit]
In 2014, the Marvel Disk Wars: The Avengers Japanese TV series was launched together with a collectible game called Bachicombat, a game similar to Pogs, by Bandai.[94]
...
Role-playing[edit]
TSR published the pen-and-paper role-playing game Marvel Super Heroes in 1984. TSR then released in 1998 the Marvel Super Heroes Adventure Game which used a different system than their first game. In 2003 Marvel Publishing published its own role-playing game, the Marvel Universe Roleplaying Game.[95]

In August 2011 Margaret Weis Productions announced it was developing a tabletop role-playing game based on the Marvel universe, set for release in February 2012.[96][97]
...
As of the start of September 2015, films based on Marvel's properties represent the highest-grossing U.S. franchise, having grossed over $7.7 billion [98] as part of a worldwide gross of over $18 billion.
...
Marvel first licensed two prose novels to Bantam Books, who printed The Avengers Battle the Earth Wrecker by Otto Binder (1967) and Captain America: The Great Gold Steal by Ted White (1968). Various publishers took up the licenses from 1978 to 2002. Also, with the various licensed films being released beginning in 1997, various publishers put out movie novelizations.[99] In 2003, following publication of the prose young adult novel Mary Jane, starring Mary Jane Watson from the Spider-Man mythos, Marvel announced the formation of the publishing imprint Marvel Press.[100] However, Marvel moved back to licensing with Pocket Books from 2005 to 2008.[99] With few books issued under the imprint, Marvel and Disney Books Group relaunched Marvel Press in 2011 with the Marvel Origin Storybooks line.[101]
...
Theme parks[edit]
Marvel has licensed[102] its characters for theme-parks and attractions, including at the Universal Orlando Resort's Islands of Adventure, in Orlando, Florida, which includes rides based on their iconic characters and costumed performers.[103] Universal theme parks in California and Japan also have Marvel rides.[104]

Walt Disney Parks and Resorts plans on creating original Marvel attractions at their theme parks,[105][106] with Hong Kong Disneyland becoming the first Disney theme park to feature a Marvel attraction.[107][108] Due to the licensing agreement with Universal Studios, signed prior to Disney's purchase of Marvel, Walt Disney World and Tokyo Disney are barred from having Marvel characters in their parks.[109] However, this only includes characters Universal is currently using, other characters in their "families" (X-Men, Avengers, Fantastic Four, etc.), and the villains associated with said characters.[102] This clause has allowed Walt Disney World to have meet and greets, merchandise, attractions and more with other Marvel characters not associated with the characters at Islands of Adventures, such as Star-Lord and Gamora from Guardians of the Galaxy[110][111] as well as Baymax and Hiro from Big Hero 6.[112]
